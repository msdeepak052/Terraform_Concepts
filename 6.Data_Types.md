# 🧠 **Terraform Input Variables — Overview**

In Terraform, **variables** (declared with `variable` blocks) are used to **parameterize configurations**, so your `.tf` files are reusable and flexible.
...
## 👉 You can define variable values via:

* `terraform.tfvars` file
* `-var` flag (CLI)
* Environment variables
* Variable defaults in `.tf` files
